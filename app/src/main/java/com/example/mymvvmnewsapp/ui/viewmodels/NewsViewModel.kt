...
class NewsViewModel(
    app: Application, private val newsRepository: NewsRepositoryImpl
    ...
    init {
        getBreakingNews(Session.user.countryCode, newsCategory, false)
    }
    ...
    fun saveArticle(article: Article) = viewModelScope.launch {
        article.uid = com.example.mymvvmnewsapp.Session.user.uid
